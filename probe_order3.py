# -*- coding: utf-8 -*-
"""probe_order3.py - 反序验证: 精确中心 + 第一行的反序(=中间行假设)点击,
同时保存指令小窗截图供肉眼核对"""
import base64
import json
import os
...
with sync_playwright() as pw:
    ...
    try:
        ...
        print('分割中心:', comps)
        try:
            page.query_selector('.cx_tips__answer_div').screenshot(
                path='captcha_cache/tip_window.png')
        except Exception as e:
            print('tip window shot fail:', e)
