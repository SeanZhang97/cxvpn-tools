...
assert.match(html, /assets\/chaoxing-network-orbit\.png/);
assert.match(html, /assets\/chaoxing-line\.png/);
assert.match(html, /assets\/chaoxing-line-paths\.png/);
assert.match(html, /assets\/chaoxing-line-star\.png/);
...
assert.match(css, /@keyframes proxy-orbit-clockwise/);
assert.match(css, /@keyframes proxy-orbit-counterclockwise/);
assert.match(css, /@keyframes proxy-orbit-pulse/);
assert.match(css, /@keyframes proxy-logo-scan/);
assert.match(css, /@keyframes proxy-star-ignite/);
assert.match(css, /\.proxy-orbit\.is-active \.proxy-orbit-motion-primary/);
assert.match(css, /\.proxy-orbit\.is-active \.proxy-star-ignite/);
